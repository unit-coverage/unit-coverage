...
function Source(sourceRoot, filename, content, excludes, fileSet) {
    ...
    this._ast = javascript.parse(content);
 ...
 * @returns {String}
 */
Source.prototype.getRootPath = function () {
...
Source.prototype.locate = function (line, column) {
    ...
    return {
        filename: loc.source,
        testName: this._fileSet.getTestName(loc.source, this._sourceRoot),
...
Source.prototype.ensureFileInfo = function (filename) {
    ...
    if (!fileInfo) {
        fileInfo = new FileInfo({
            ...
            testName: this._fileSet.getTestName(filename, this._sourceRoot)
        });
